...
\item[CashierController] is responsible for the interactions between the CashierInterface and the GSCS system.
\item[AccountController] is responsible for the interactions between the and the GSCS system.
\end{description}
...
public class CollectiveAccount extends Account {
	private int number; // TODO: necessary?
