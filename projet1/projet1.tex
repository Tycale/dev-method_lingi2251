...
\item \enquote{the paper credit card receipt will be photocopied and stored with the rest of the year’s receipts}. This action can not be handled by a computer system.. This action have to be managed by the cashier. We can think of being able to save the scan of the credit card receipt in the database of the system via the cashier interface. We do not take into account this sentence.
